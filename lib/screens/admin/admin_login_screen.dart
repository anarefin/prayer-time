...
/// Reusable Admin Login Content Widget
class AdminLoginContent extends StatefulWidget {
  final VoidCallback? onLoginSuccess;

  const AdminLoginContent({super.key, this.onLoginSuccess});
  ...
  Future<void> _login() async {
    ...
    if (_isLockedOut) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Account temporarily locked. Try again in $_remainingLockoutTime',
          ),
